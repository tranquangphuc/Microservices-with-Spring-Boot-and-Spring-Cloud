...
function assertCurl() {
    ...
    then
        ...
        echo "Test FAILED, EXPECTED HTTP Code: $expectedHtpCode, GOT: $httpCode, WILL ABORT!"
...
# Verify that a normal request workds, expect three recommendations and three reviews
...
assertCurl 400 "curl http://$HOST:$PORT/product-composite/abc -s"
assertEqual "\"Method parameter 'productId': Failed to convert value of type 'java.lang.String' to required type 'int'; For input string: \\\"abc\\\"\"" "$(echo $RESPONSE | jq .message)"
